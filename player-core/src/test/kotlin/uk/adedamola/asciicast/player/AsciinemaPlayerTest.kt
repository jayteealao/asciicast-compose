...
class AsciinemaPlayerTest {
    ...
    @Test
    fun `load recording initializes terminal`() =
        runTest {
            val cast =
                """
    ...
    @Test
    fun `play feeds events to terminal`() =
        runTest {
            val cast =
                """
                {"version":2,"width":80,"height":24}
    ...
    @Test
    fun `setSpeed adjusts playback rate`() =
        runTest {
    ...
    @Test
    fun `setIdleTimeLimit configures compression`() =
        runTest {
    ...
    @Test
    fun `markers are collected during playback`() =
        runTest {
            val cast =
                """
                {"version":2,"width":80,"height":24}
    ...
    @Test
    fun `resize event updates terminal size`() =
        runTest {
            val cast =
                """
                {"version":2,"width":80,"height":24}
    ...
    @Test
    fun `playback ends with Ended state`() =
        runTest {
            val cast =
                """
                {"version":2,"width":80,"height":24}
